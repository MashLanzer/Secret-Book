      ...
      >
        ...
        <div className="glass-strong p-8 rounded-3xl">
          ...
          <p className="text-white/50 text-sm text-center mb-8">
            Inicia sesión con tu cuenta de Google para acceder a tu libro secreto
          </p>

          <button
            onClick={handleGoogle}
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl font-semibold text-white transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50"
